...
gulp.task('js', function () {
    jsModules.forEach(function (jsPath) {
        var pathArr = jsPath.split('/'); //pathArr返回结果['src','js','user'login.js']
        var jsName = pathArr.pop(); //提取login.js 返回结果是['src','js','user'] ----这个是想还要的jsName
        pathArr.shift(); //提取src  变成['js',user]----这个是想要的路径
